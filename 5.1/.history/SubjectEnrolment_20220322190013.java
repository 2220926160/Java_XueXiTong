...
public class SubjectEnrolment {
    ...
    public SubjectEnrolment(int studentMax) {
    ...
    public String toString() {
        ...
        return "SubjectEnrolment [count=" + count + ", studentList=" + Arrays.toString(studentList) + ", subjectId="
                + subjectId + ", subjectIdFirst=" + subjectIdFirst + ", subjectName=" + subjectName + "]";
    }
}
