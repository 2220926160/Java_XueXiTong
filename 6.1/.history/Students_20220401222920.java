...
public class Students {
    ...
    public Students(String T1, String T2) {
        ...
        // for (String i : splitT1) {
        //     System.out.println(i);
        // }
        // System.out.println("T2:");
        // for (String i : splitT2) {
        //     System.out.println(i);
        // }
        for (int i = 0; !splitT1[i].isEmpty() && !splitT1[i].equals("end");) {
            StudentInformation studentInformation = new StudentInformation(splitT1[i], splitT1[i + 1], splitT1[i + 1]);
        ...
        for (int i = 0; !splitT2[i].isEmpty() && !splitT2[i].equals("end");) {
            StudentGrade studentGrade = new StudentGrade(splitT2[i], splitT2[i++], Float.parseFloat(splitT2[i++]));
