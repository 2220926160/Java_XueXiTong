    ...
    public static void main(String args[]) {
        ...
        while (!isExit) {
            ...
            if (choice == 1) { // input score
                ...
                Arrays.sort(grades, 0, IdexNULL(grades));
                System.out.println("Sort succeeded!");
            } else if (choice == 6) { // show
                if (IsNULL(grades)) {
                    System.out.println("Please enter your scores first");
                    continue;
                }
                System.out.println("+------------------------+");
                for (int i = 0; grades[i] != null && i < grades.length; i++) {
