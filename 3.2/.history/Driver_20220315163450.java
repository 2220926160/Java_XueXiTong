...
public class Driver {
    public static void main(String[] args) {
        ...
        // Isubject subject = new Subject(input);
        // System.out.println(subject.toString());

        // IStudent student = new Student(input);
        // System.out.println(student.toString());


        ClassList classList = creat(input);
        // int choice;
        // while (true) {
        //     choice = showMenu();
        //     switch (choice) {
        //         case 1:
        //             classList = creat(input);
        //             break;
        //         case 2:
        //             if (classList == null) {
    ...
    public static ClassList creat(Scanner input) {
        ClassList classList = new ClassList(input);
        return classList;
    }
