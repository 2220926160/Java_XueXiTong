...
public class ClassList implements IStudent, Isubject{
    ...
    public ClassList(Scanner input) {
        System.out.print("请输入学期:");
        this.semester = input.nextInt();
        System.out.print("请输入年份:");
        this.year = input.nextInt();
        this.subj = new Subject(input);
        this.s1 = new Student(input);
        this.s2 = new Student(input);
    }
