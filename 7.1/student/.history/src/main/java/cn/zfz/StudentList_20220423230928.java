...
public class StudentList {
    ...
    public ArrayList<StudentInfo> search_id() {
        ArrayList<StudentInfo> seach_id_list = new ArrayList<StudentInfo>();
    }
    // 返回记录数
    public int size() {
...
class StudentInfo {
    ...
    public String toString(String splitSymbol) {
        String str = "";
        str += id + splitSymbol + name + splitSymbol + gender + course + splitSymbol + grade;
        return str;
    }
