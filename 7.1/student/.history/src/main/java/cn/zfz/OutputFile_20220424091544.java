    ...
    public boolean outputXml() {
        try {
            ...
            for (StudentInfo studentInfo : studentList) {
                ...
                stduent.addElement("id").addElement(studentInfo.getId());
                stduent.addElement("name").addElement(studentInfo.getName());
                stduent.addElement("gender").addElement(studentInfo.getGender());
                stduent.addElement("course").addElement(studentInfo.getCourse());
                stduent.addElement("grade").addElement(studentInfo.getGrade().toString());
            }
