...
public class Menu {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3: // 从 xml 文件加载数据
                    ...
                    break;
                case 4:
                    studentList.setStudentList(loadFromJson("data/student.json"));
                    break;
                case 5: // 键盘输入数据
                ...
                case 9: // 输出到 xml 文件
                    ...
                    break;
                case 10:
                saveToXml("data/student.json", studentList.getStudentList());
    ...
    public ArrayList<StudentInfo> loadFromJson(String pathJson) {
        InputFile inputFile = new InputFile();
        inputFile.setPathJson(pathJson);
        inputFile.InputJson();
        return inputFile.getStudentList();
    }
    ...
    public void saveToJson(String pathJson, ArrayList<StudentInfo> studentList) {
        OutputFile outputFile = new OutputFile(studentList);
        outputFile.setPathJson(pathJson);
