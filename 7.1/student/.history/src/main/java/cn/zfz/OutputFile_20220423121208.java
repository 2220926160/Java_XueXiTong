...
public class OutputFile {
    ...
    public boolean outputTxt() {
        ...
        try {
            ...
            for (StudentInfo studentInfo : studentList) {
                String str = "";
        str += studentInfo.getId() + splitSymbol + studentInfo.getName() + splitSymbol + studentInfo.getGender() + splitSymbol + studentInfo.getCourse() + splitSymbol + studentInfo.getGrade();
            }
            // fileOutputStream.write(studentList.toString(" ").getBytes());
