    ...
    public boolean InputXml() {
        try {
            ...
            for (Element e : elements) {
                String student = e.attributeValue("student");
                ...
                StudentInfo studentInfo = new StudentInfo(idElement.getText(), nameElement.getText(), genderElement.getText(), courseElement.getText(), Float.parseFloat(gradeElement.getText()));
